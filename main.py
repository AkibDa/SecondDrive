...
def check_price_tab(df, model, scaler):
  ...
  if st.button("Estimate Price"):
    ...
    numeric_to_scale = ['mileage_kmpl', 'engine_cc', 'car_age'] if 'car_age' in expected_features else ['mileage_kmpl',
                                                                                                        'engine_cc',
                                                                                                        'make_year']
...
def main():
  ...
  with tab1:
    check_price_tab(df, model, scaler)
